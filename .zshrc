...
alias ll="exa -hbl --git --group-directories-first"
alias fj="jira open \$(jira i | fzf)"
...
#function chromi() {
#  echo "$1"
#  chromium "$1" --args --user-data-dir='$HOME'/ --disable-web-security --remote-debugging-port=9222 --ignore-certificate-errors
#}
